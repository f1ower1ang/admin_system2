...
Print.prototype = {
  ...
  getStyle: function () {
    ...
    str += "<style>html,body,.map{height: auto!important;} .chart,.title{width:100%;}</style>";
  ...
  getHtml: function () {
    ...
    var pages = document.querySelectorAll('.results');
  ...
  writeIframe: function (content) {
    ...
    iframe.setAttribute('style', 'position:absolute;width:' +
      document.querySelector('.results').clientWidth + 'px;height:0;top:-10px;left:0px;');
